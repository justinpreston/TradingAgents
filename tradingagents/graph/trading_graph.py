...
class TradingAgentsGraph:
    ...
    def __init__(
        ...
        progress_listener: Any | None = None,
    ):
        ...
        return {
            ...
            "news": ToolNode(
                [
                    ...
                    get_news,
                    get_global_news,
                    # Macro + prediction-market context (new upstream tools the
                    # news_analyst now references). Insider stays in the
                    # fundamentals ToolNode below — the news_analyst does not
                    # bind it.
                    get_macro_indicators,
                    get_prediction_markets,
                ]
